...
import { default as __fd_glob_26 } from "../content/docs/billing/meta.json?collection=meta"
import { default as __fd_glob_25 } from "../content/docs/getting-started/meta.json?collection=meta"
...
import * as __fd_glob_13 from "../content/docs/billing/plan-upgrades.mdx?collection=docs"
import * as __fd_glob_12 from "../content/docs/billing/payment-methods.mdx?collection=docs"
import * as __fd_glob_11 from "../content/docs/billing/invoices.mdx?collection=docs"
import * as __fd_glob_10 from "../content/docs/getting-started/email-verification.mdx?collection=docs"
import * as __fd_glob_9 from "../content/docs/getting-started/dashboard-overview.mdx?collection=docs"
import * as __fd_glob_8 from "../content/docs/getting-started/creating-account.mdx?collection=docs"
...
export const docs = await create.doc("docs", "content/docs", {"index.mdx": __fd_glob_0, "_developer/api.mdx": __fd_glob_1, "_developer/cli.mdx": __fd_glob_2, "_developer/webhooks.mdx": __fd_glob_3, "domains/auth-codes.mdx": __fd_glob_4, "domains/nameservers-dns.mdx": __fd_glob_5, "domains/registering-domains.mdx": __fd_glob_6, "domains/transferring-domains.mdx": __fd_glob_7, "getting-started/creating-account.mdx": __fd_glob_8, "getting-started/dashboard-overview.mdx": __fd_glob_9, "getting-started/email-verification.mdx": __fd_glob_10, "billing/invoices.mdx": __fd_glob_11, "billing/payment-methods.mdx": __fd_glob_12, "billing/plan-upgrades.mdx": __fd_glob_13, "hosting/cpanel-access.mdx": __fd_glob_14, "hosting/databases.mdx": __fd_glob_15, "hosting/email-accounts.mdx": __fd_glob_16, "hosting/php-versions.mdx": __fd_glob_17, "hosting/wordpress-install.mdx": __fd_glob_18, "ssl/automated-ssl.mdx": __fd_glob_19, "ssl/https-redirection.mdx": __fd_glob_20, "ssl/troubleshooting.mdx": __fd_glob_21, });

export const meta = await create.meta("meta", "content/docs", {"meta.json": __fd_glob_22, "_developer/meta.json": __fd_glob_23, "domains/meta.json": __fd_glob_24, "getting-started/meta.json": __fd_glob_25, "billing/meta.json": __fd_glob_26, "hosting/meta.json": __fd_glob_27, "ssl/meta.json": __fd_glob_28, });